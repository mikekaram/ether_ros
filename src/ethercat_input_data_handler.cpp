 ...
 *****************************************************************************/
/**
   \file ethercat_input_data_handler.cpp
   \brief Implementation of EthercatInputDataHandler class.

   Used for handling the "raw" input data, received from EtherCAT Communicator and transforming them into
