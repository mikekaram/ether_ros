...
# Exoume: ecrt_master_send, e1000_xmit_frame, ecrt_master_receive, e1000_intr_msi, ec_master_receive_datagrams
sudo trace-cmd record -p function_graph -l ecrt_master_send -l e1000_intr_msi -l ecrt_master_receive -l e1000_xmit_frame -l ec_master_receive_datagrams